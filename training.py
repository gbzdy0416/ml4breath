...
def load_and_prepare_data(csv_path='things.csv'):
    #Loading data
    ...
    return train_test_split(input_set, output_set, test_size=0.2, random_state=42)
...
def train_model():
    ...
    sample_weight[:weighted_count] = 17.0

    #Building and training the model
    print("Data prepared. Start training model...")
    model = build_model((3,))
    model.fit(input_train, output_train, batch_size=16, epochs=50, sample_weight=sample_weight)
